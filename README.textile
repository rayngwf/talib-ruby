...
To install under Windows the ruby development kit is required to build the binary extensions. Download and install instructions can be found at "DevKit":https://github.com/oneclick/rubyinstaller/wiki/Development-Kit:.
...
From the folder where the ruby devkit was installed double click on msys.bar.

Navigate to the directory where ta-lib source was extracted and type the following to build the library:
bc. ./configure
bc. make
