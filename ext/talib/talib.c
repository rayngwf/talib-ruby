 ...
 * Return hint.
 */
static VALUE ta_func_get_hint(VALUE self)
{
  return rb_str_new2((abstract_layer_get_func_info(rb_iv_get(self, "@name")))->hint);
}

/*
 * Return camel case name.
 */
static VALUE ta_func_get_camel_case_name(VALUE self)
{
  return rb_str_new2((abstract_layer_get_func_info(rb_iv_get(self, "@name")))->camelCaseName);
}
